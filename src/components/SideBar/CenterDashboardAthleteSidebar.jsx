		...
		<div id="homeDashboardFeedUI" className="center-sidebar-container">
			<Container>
				...
				{activities.map((activity) => (
					<Card key={activity.id} style={{ width: "auto", marginBottom: "14px" }}>
					<Card.Body>
						<Card.Text>
							<Row>
								<div className="feed-ui-card">
								...
								<div className="feed-ui-media-activity">
									...
									<div className="feed-ui-media-stats">
										<div className="media-stats-wrapper">
											<div>
												<p className="media-stats-para">Distance</p>
												<p className="media-stats-para-numbers">{activity.distance} Km</p>
											</div>

											<div>
												<p className="media-stats-para">Elev Gain</p>
												<p className="media-stats-para-numbers">{activity.elevation} m</p>
											</div>

											<div>
												<p className="media-stats-para">Time</p>
												<p className="media-stats-para-numbers">{activity.hour}h {activity.minute}m {activity.second}s</p>
											</div>
										</div>
									</div>
								</div>
