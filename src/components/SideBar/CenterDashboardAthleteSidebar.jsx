                ...
                <Card.Body>
                        ...
                        <div className="feed-ui-card">
                            ...
                            <div className="feed-ui-user-info">
                                ...
                                <p className="feed-ui-user-location">
                                    <time data-test id="date_at_time">22 September 2023 at 09:09</time>
                                    <br></br>
                                    <span>
                    ...
                    <Card.Text id="feedUIPackages">
                        <div className="feed-ui-media">
                            <div className="feed-ui-run-icon">
                                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="------packages-feed-ui-src-features-Activity-Activity__activity-icon--lq3sA">
                                    <title>Run</title>
                    ...
                    <Card.Text id="celebrationsWrapper">
                        <div className="feed-ui-celebration-title">
                            ...
                            <a href="home" aria-label="Congrats! You just set your 3rd fastest time in the 1 mile!">Congrats! You just set your 3rd fastest time in the 1 mile!</a>
                        </div>
                    </Card.Text>
                    <Card.Text>
                        <div className="feed-ui-activity-images">
                            <div className="feed-ui-activity-imageLeft">
                                <a href="home">
                                    <Card.Img variant="top" src={runningRoute} width={287} height={287} />
                                    <Button title="View all kudos" variant="primary">Start and end hidden</Button>
                                    <Button title="View all kudos" variant="primary" id="saveRouteBtn">Save Route</Button>
                                </a>
                            </div>
                            <div className="feed-ui-activity-imageLeft">
                                <a href="home">
                                    <Card.Img variant="top" src={runningView} width={287} height={287} />
