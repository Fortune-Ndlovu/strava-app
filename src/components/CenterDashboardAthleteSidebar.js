...
function CenterDashboardAthleteSidebar({athlete, activities}) {
    ...
    return (<div id="homeDashboardFeedUI">
        <Dropdown id="userActivities">
            <Dropdown.Toggle variant="success" id="userActivities-dropdownBtn-list"> {selectedUserActivityUI}
            ...
            <Card.Body>
                ...
                <Card.Text id="feedUIPackages">
                    <div className="feed-ui-media">
                        ...
                        <div className="feed-ui-media-activity">
                            <h4><a href="home"> Morning Run </a></h4>
                ...
                <Card.Text id="celebrationsWrapper">
                    <div className="feed-ui-celebration-title">
                        <Card.Img variant="top" src={celebration_bronze_icon} width={32} height={32} />
