	...
	return (
		<div className="App">
			<div className="dashboard-container">
				<Container>
                    <div id="text">
						<Row id="dashboardContainerRow">
                            <Col xs={3} md={6}  lg={3} id="LeftDashboardAthleteSidebarCol">
								<div
									className="LeftDashboardAthleteSidebar"
								>
									<LeftDashboardAthleteSidebar
										athlete={athlete}
							...
							<Col lg={3} id="RightDashboardAthleteSidebarCol">
